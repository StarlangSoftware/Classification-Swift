...
A directory called Sampling-Swift will be created. Or you can use below link for exploring the code:
	...
	git clone https://github.com/starlangsoftware/Classification-Swift.git
...
After being done with the downloading and opening project, select **Build** option from **Product** menu. After compilation process, user can run Classification-Swift.
...
Algoritmaları eğitmek için
	...
	func train(trainSet: InstanceList, parameters: Parameter)

Eğitilen modeli bir veri örneği üstünde sınamak için

	func predict(instance: Instance) -> String
